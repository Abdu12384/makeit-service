...
exports.BlockEventUseCase = void 0;
...
let BlockEventUseCase = class BlockEventUseCase {
    ...
    blockEvent(eventId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._eventRepository.update({ eventId }, { isActive });
        });
    }
};
exports.BlockEventUseCase = BlockEventUseCase;
exports.BlockEventUseCase = BlockEventUseCase = __decorate([
