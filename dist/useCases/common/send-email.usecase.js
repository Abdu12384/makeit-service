...
let SendEmailUseCase = class SendEmailUseCase {
    constructor(_emailSerivice) {
        this._emailSerivice = _emailSerivice;
    }
    execute(to, subject, content) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._emailSerivice.sendCustomEmail(to, subject, content);
        });
    }
};
...
//# sourceMappingURL=send-email.usecase.js.map