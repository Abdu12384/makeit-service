...
exports.UpdateUserDetailsUseCase = void 0;
...
let UpdateUserDetailsUseCase = class UpdateUserDetailsUseCase {
    ...
    execute(userId, role, userDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield repository.update({ userId }, userDetails);
            if (!user) {
...
exports.UpdateUserDetailsUseCase = UpdateUserDetailsUseCase;
exports.UpdateUserDetailsUseCase = UpdateUserDetailsUseCase = __decorate([
...
//# sourceMappingURL=update-user-details.usecase.js.map