...
exports.UpdateWorkSampleUseCase = void 0;
...
let UpdateWorkSampleUseCase = class UpdateWorkSampleUseCase {
    ...
    execute(workSampleId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const workSample = yield this._workSampleRepository.findOne({ workSampleId });
            if (!workSample) {
                throw new custom_error_1.CustomError(constants_1.ERROR_MESSAGES.REQUEST_NOT_FOUND, constants_1.HTTP_STATUS.NOT_FOUND);
            }
            yield this._workSampleRepository.update({ workSampleId }, Object.assign({}, data));
        });
    }
};
exports.UpdateWorkSampleUseCase = UpdateWorkSampleUseCase;
exports.UpdateWorkSampleUseCase = UpdateWorkSampleUseCase = __decorate([
